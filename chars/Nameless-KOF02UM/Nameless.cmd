...
trigger7 = stateno = 250 && AnimElemTime(6) > 0 && AnimElemTime(9) < 2
var(1) = 1

[State -1, Combo]
type = VarSet
triggerall = !ishelper
trigger1 = stateno = 440 && AnimElemTime(5) > 0 && AnimElemTime(7) < 2
...
type = VarSet
triggerall = !ishelper
trigger1 = stateno = 300 && AnimElemTime(4) >= 0 && AnimElemTime(7) < 0 && movecontact
trigger1 = var(27) = 0
trigger2 = stateno = 1000 && AnimElemTime(8) >= 0 && AnimElemTime(11) < 0 && movecontact
trigger3 = stateno = 1010 && AnimElemTime(8) >= 0 && AnimElemTime(11) < 0 && movecontact
trigger4 = stateno = 1100 && movecontact = [1,6]
trigger5 = stateno = 1110 && AnimElemTime(6) >= 0 && AnimElemTime(8) < 0 && movecontact
var(1) = 3
...
trigger2 =!(stateno = 1110 && AnimElemTime(7) >= 0)
var(2) = 1
...
triggerall = command = "最終型抜手刀秘技・燐光" || helper(99999),var(25) > 0 && command = "holdx"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "回転型突貫奥技・螺旋" || helper(99999),var(24) > 0 && (command = "holdx" && command = "holdy" && command = "holda" && command = "holdb")
triggerall = power >= 3000 && var(40) = 0 || power >= 1000 && var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱拡散型抜手刀奥技・絶影" || helper(99999),var(22) > 0 && command = "holdx"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強拡散型抜手刀奥技・絶影" || helper(99999),var(23) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱閃光型抜手刀奥技・灼鳳" || helper(99999),var(20) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強閃光型抜手刀奥技・灼鳳" || helper(99999),var(21) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱対空型抜手刀戦技・宵月" || helper(99999),var(12) > 0 && command = "holdx"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強対空型抜手刀戦技・宵月" || helper(99999),var(13) > 0 && command = "holdy"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱強襲型抜手刀戦技・天霧" || helper(99999),var(14) > 0 && command = "holda"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強強襲型抜手刀戦技・天霧" || helper(99999),var(15) > 0 && command = "holdb"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱地走型抜手刀戦技・早蕨" || helper(99999),var(10) > 0 && command = "holdx"
triggerall = statetype != A
triggerall =!numproj
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強地走型抜手刀戦技・早蕨" || helper(99999),var(11) > 0 && command = "holdy"
triggerall = statetype != A
triggerall =!numproj
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall = (stateno = 150 || stateno = 152) && HitShakeOver
trigger1 = enemynear(var(58)),statetype != A
trigger1 = Random <= 100 || power >= 4000 && var(40) = 0 && enemynear(var(58)),life <= 300
trigger2 = enemynear(var(58)),statetype = A
trigger2 = p2bodydist y = [-60-floor(6*(enemynear(var(58)),vel y)+(6*(6+1)/2)*fvar(39)),0-floor(6*(enemynear(var(58)),vel y)+(6*(6+1)/2)*fvar(39))]
trigger2 = Random <= 200 || power >= 4000 && var(40) = 0 && enemynear(var(58)),life <= 300
...
trigger6 = enemynear(var(58)),ctrl = 1
trigger7 = roundstate != 2
trigger8 = var(50) = 1 && (stateno = 245 || stateno = 1100) && movehit
var(50) = 0
...
triggerall = statetype != A
triggerall = enemynear(var(58)),movetype = H
trigger1 = stateno = 245 && movehit = 3
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
triggerall = p2bodydist y = [-20-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39)),0-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39))]
trigger1 = ctrl || stateno = 0 || (stateno = [20,22]) || (stateno = [99,101]) || (stateno = [120,149])
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || (var(1) = [1,2]) && !movecontact && movetype != H
trigger1 = p2bodydist x = [ifelse(backedgebodydist<=10,-20,-30+floor(10*(enemynear(var(58)),vel x))),70+floor(10*(enemynear(var(58)),vel x))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = p2bodydist x = [ifelse(backedgebodydist<=10,-20,-10+floor(5*(enemynear(var(58)),vel x))),40+floor(5*(enemynear(var(58)),vel x))]
...
triggerall = enemynear(var(58)),MoveType != H
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20,50+floor(17*(EnemyNear(Var(58)),vel X)+floor(17*vel X))]
triggerall = enemynear(var(58)),Pos Y - Pos Y = [-80,20]
trigger1 = ctrl || stateno = 55 || (stateno = [120,149])
