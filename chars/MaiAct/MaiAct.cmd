...
trigger13 = MoveContact && (StateNo = 1700 && AnimElemTime(3) >= 1 && AnimElemTime(3) <= 10) && Power >= 3000-fVar(2)
trigger14 = MoveContact && (StateNo = 1750 && AnimElemTime(3) >= 1 && AnimElemTime(3) <= 10) && Power >= 3000-fVar(2)
...
type = ChangeState
value = 3401
triggerall = Command = "KyubiNoKitsune" && Life<=Var(7) && Power >= 2000-fVar(2)
trigger1 = MoveContact && (StateNo = 3010 || StateNo = 3060 || StateNo = 3020 || StateNo = 3070 || StateNo = 3310 || StateNo = 3020) && Power>=3000-fVar(2)
trigger2 = MoveContact && (StateNo = 3020 || StateNo = 3070) && Power>=2000-fVar(2)
trigger3 = ProjContact(3750)=1 && (StateNo = 3700 || StateNo = 3750) && Power>=2000-fVar(2)
trigger4 = MoveContact && (StateNo = [3820,3860]) && Power>=2000-fVar(2)
...
trigger15 = MoveContact && (StateNo = 1700 && AnimElemTime(3) >= 1 && AnimElemTime(3) <= 10) && Power >= 3000-fVar(2)
trigger16 = MoveContact && (StateNo = 1750 && AnimElemTime(3) >= 1 && AnimElemTime(3) <= 10) && Power >= 3000-fVar(2)
