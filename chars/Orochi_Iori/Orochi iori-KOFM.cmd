...
trigger9 = stateno = 1751 && AnimElemtime(1) > 0 && AnimElemtime(2) <= 2 && movecontact
trigger10 = stateno = 1810 && AnimElemtime(5) > 0 && AnimElemtime(6) <= 2 && movecontact
trigger11 = stateno = 1811 && AnimElemtime(5) > 0 && AnimElemtime(6) <= 2 && movecontact
trigger12 = stateno = 1260 && AnimElemtime(4) > 0 && AnimElemtime(5) < 10 && movecontact
trigger13 = stateno = 100
trigger14 = stateno = 310 && movecontact
trigger15 = stateno = 2510 && AnimElemtime(5) > 0 && AnimElemtime(45) < 0 && movecontact
triggerall = var(50) = 0
triggerall = enemy,var(46) = 0
...
[State -3]
type = ChangeState
value = ifelse(random<=999,235,215)
triggerall = var(50)!= 0
triggerall = statetype != A
...
trigger1 = p2movetype != H
trigger1 = random <= 100
trigger2 = Helper(1000),MoveGuarded
trigger2 = p2stateno = 5120 || p2stateno = [120,159]
trigger3 = Helper(1000),MoveGuarded
trigger4 = Helper(1000),Movehit
trigger4 = p2stateno = [5000,5172]
...
trigger3 = Helper(1000),MoveGuarded
trigger3 = p2bodydist x = [90,125]

[State -3]
type = ChangeState
Value = ifelse((p2bodydist x = [-10,50]),38,39)
triggerall = var(50) != 0
triggerall = roundstate = 2
TriggerAll = statetype != A
TriggerAll = p2statetype = L
Triggerall = facing != enemynear,facing
triggerall = ctrl || (stateno = [100,101]) || (stateno = 52 && Time >= 3)
...
triggerall = roundstate = 2
triggerall = movehit
trigger1 = stateno = 1751 && anim = 1711 && animelem = 4, >= 5
...
[State AI]
type = ChangeState
value = ifelse((random<=500),1300,1370)
triggerall = var(50) != 0
triggerall = random <= 999
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((power>=3000),3300,1800)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = p2movetype = H
triggerall = random <= 999
...
[State AI]
type = ChangeState
value = ifelse((random<=400),1250,2050)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
...
[State AI]
type = ChangeState
value = ifelse((random<=700),1750,1270)
triggerall = var(50) != 0
triggerall = p2statetype = A
triggerall = random <= 999
triggerall = movehit
