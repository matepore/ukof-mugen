...
trigger2 = stateno = 210 && AnimElemTime(4) > 0 && AnimElemTime(6) < 2
trigger3 = stateno = 215 && AnimElemTime(3) > 0 && AnimElemTime(6) < 2
trigger4 = stateno = 235 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger5 = stateno = 245 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger6 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger7 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger8 = stateno = 430 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger9 = stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger10 = stateno = 640 && AnimElemTime(4) > 0 && AnimElemTime(6) < 2
var(1) = 1
...
trigger2 = stateno = 315 && AnimElemTime(6) > 0 && AnimElemTime(9) < 2
trigger3 = stateno = 320 && AnimElemTime(6) > 0 && AnimElemTime(8) < 0
trigger4 = stateno = 325 && AnimElemTime(6) > 0 && AnimElemTime(8) < 0
var(1) = 2

[State -1, SC]
type = VarSet
triggerall = !ishelper
trigger1 = stateno = 1100 && AnimElemTime(4) >= 0 && AnimElemTime(7) < 0 && movecontact
trigger2 = stateno = 1110 && AnimElemTime(4) >= 0 && AnimElemTime(6) < 0 && movecontact
trigger3 = stateno = 1220 && movecontact = [1,6]
var(1) = 3
...
triggerall = command = "クリムゾンスターロード" || helper(99999),var(40) > 0 && command = "holdx"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "MAXチェーンドライブ" || helper(99999),var(35) > 0 && (command = "holdx" && command = "holdy")
triggerall = power >= 3000 && var(40) = 0 || power >= 1000 && var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱チェーンドライブ" || helper(99999),var(32) > 0 && command = "holdx"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強チェーンドライブ" || helper(99999),var(33) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ヒートドライブ" || helper(99999),var(30) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ヒートドライブ" || helper(99999),var(31) > 0 && command = "holdx"
triggerall = power >= 1000 && var(40) = 0 || var(40) > 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱クロウバイツ" || helper(99999),var(12) > 0 && command = "holdx"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強クロウバイツ" || helper(99999),var(13) > 0 && command = "holdy"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ミニッツスパイク" || helper(99999),var(14) > 0 && command = "holda"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
trigger4 = var(2) = 1 && stateno != [1200,1299]
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ミニッツスパイク" || helper(99999),var(15) > 0 && command = "holdb"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ブラックアウト" || helper(99999),var(16) > 0 && command = "holda"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ブラックアウト" || helper(99999),var(17) > 0 && command = "holdb"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall = p2bodydist y = [-30-floor(3*(enemynear(var(58)),vel y)+(3*(3+1)/2)*fvar(39)),15-floor(3*(enemynear(var(58)),vel y)+(3*(3+1)/2)*fvar(39))]
...
trigger1 = stateno = 1100 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0 && movecontact
...
triggerall = enemynear(var(58)),stateno != 5700 && enemynear(var(58)),stateno != [5710,5715]
triggerall = movehit = [1,4]
trigger1 = stateno = 1100 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0
...
triggerall = p2bodydist y = [-20-floor(3*(enemynear(var(58)),vel y)+(3*(3+1)/2)*fvar(39)),15-floor(3*(enemynear(var(58)),vel y)+(3*(3+1)/2)*fvar(39))]
trigger1 = ctrl || stateno = 0 || (stateno = [20,22]) || (stateno = [99,101]) || (stateno = [120,149])
...
triggerall = frontedgebodydist <= 60
triggerall = movehit = [1,4]
trigger1 = stateno = 215 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2
trigger2 = stateno = 245 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger3 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger4 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger5 = stateno = 430 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger6 = stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2 && moveguarded
trigger7 = stateno = 300 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2 && moveguarded
trigger8 = stateno = 315 && AnimElemTime(6) > 0 && AnimElemTime(9) < 2
...
triggerall = enemynear(var(58)),movetype = H
triggerall = movehit = [1,4]
trigger1 = stateno = 210 && AnimElemTime(4) > 0 && AnimElemTime(6) < 2
trigger2 = stateno = 215 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2
trigger3 = stateno = 245 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger4 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger5 = stateno = 315 && AnimElemTime(6) > 0 && AnimElemTime(9) < 2
...
triggerall = enemynear(var(58)),stateno != 5700 && enemynear(var(58)),stateno != [5710,5715]
triggerall = movehit = [1,4]
trigger1 = stateno = 320 && AnimElemTime(7) > 0 && AnimElemTime(9) < 0
trigger2 = stateno = 325 && AnimElemTime(7) > 0 && AnimElemTime(9) < 0
...
trigger5 = var(44) = 5 && enemynear(var(58)),stateno = 5120
...
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = enemynear(var(58)),stateno = 5120
trigger1 = enemynear(var(58)),animtime = [-13,-9]
...
trigger1 = p2bodydist y = [-50-floor(4*(enemynear(var(58)),vel y)+(4*(4+1)/2)*fvar(39)),0-floor(4*(enemynear(var(58)),vel y)+(4*(4+1)/2)*fvar(39))]
...
trigger2 = var(52) != 2 && var(52) != 3
trigger2 = enemynear(var(58)),statetype != A
trigger2 = Vel Y >= 0 && Pos Y >= -68-floor(9*vel Y) || stateno = 55 && Time >= 11
