...
triggerall = command = "弱重ね当て" || helper(99999),var(10) > 0; && command = "holdx"
triggerall = statetype = A
trigger1 = (ctrl || stateno = 55) && Pos Y <= -40 || stateno = 105 || stateno = 110
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall = enemynear(var(58)),MoveType = A
triggerall = enemynear(var(58)),StateNo >= 200
triggerall = enemynear(var(58)),HitDefAttr = A,NA,SA,HA
triggerall = enemynear(var(58)),facing != facing
triggerall = !enemy,NumProj
triggerall = p2bodydist x <= 100
triggerall = PrevStateNo != [700,710]
...
triggerall = enemynear(var(58)),MoveType = A
triggerall = enemynear(var(58)),StateNo >= 200
triggerall = enemynear(var(58)),HitDefAttr = S,NA,SA,HA
triggerall = enemynear(var(58)),facing != facing
triggerall = !enemy,NumProj
triggerall = p2bodydist x <= 100
triggerall = PrevStateNo != [700,710]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20+floor(8*(EnemyNear(Var(58)),vel X)+floor(8*vel X)),40+floor(8*(EnemyNear(Var(58)),vel X)+floor(8*vel X))]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
