...
[State -1, Combo]
type = VarSet
trigger1 = stateno = 215 && AnimElemTime(7) > 0 && AnimElemTime(9) < 0
trigger1 = var(10) = 1
trigger2 = stateno = 215 && AnimElemTime(10) > 0 && AnimElemTime(11) < 2
trigger3 = stateno = 235 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger4 = stateno = 245 && AnimElemTime(7) > 0 && AnimElemTime(8) < 2
trigger5 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(5) < 0
trigger6 = stateno = 410 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger7 = stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
var(1) = 1

[State -1, Combo]
type = VarSet
trigger1 = stateno = 250 && AnimElemTime(9) > 0 && AnimElemTime(10) < 0
trigger2 = stateno = 305 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0
trigger3 = stateno = 725 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
var(1) = 2
...
triggerall = command = "MAXハイデルンエンド" || helper(99999),var(35) > 0 && (command = "holda" && command = "holdb")
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ハイデルンエンド" || helper(99999),var(33) > 0 && command = "holda"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ハイデルンエンド" || helper(99999),var(34) > 0 && command = "holdb"
triggerall = var(9) = 0 && (power >= 1000 && var(40) > 0) || var(9) = 1 && ((1000*Life/LifeMax) <= 250 && var(40))
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "MAXファイナルブリンガー" || helper(99999),var(32) > 0 && (command = "holdx" && command = "holdy")
triggerall = var(9) = 0 && (power >= 3000 && var(40) = 0)
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ファイナルブリンガー" || helper(99999),var(30) > 0 && command = "holdx"
triggerall = var(9) = 0 && (power >= 1000 && var(40) > 0) || var(9) = 1 && ((1000*Life/LifeMax) <= 250 && var(40))
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ファイナルブリンガー" || helper(99999),var(31) > 0 && command = "holdy"
triggerall = var(9) = 0 && (power >= 1000 && var(40) > 0) || var(9) = 1 && ((1000*Life/LifeMax) <= 250 && var(40))
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ストームブリンガー" || helper(99999),var(16) > 0 && command = "holdx"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ストームブリンガー" || helper(99999),var(17) > 0 && command = "holdy"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱キリングブリンガー" || helper(99999),var(18) > 0 && command = "holda"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強キリングブリンガー" || helper(99999),var(19) > 0 && command = "holdb"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱クロスカッター" && Helper(99999),fvar(3) > 0 || Helper(99999),var(10) > 0 && command = "holdx"
triggerall = statetype != A
triggerall =!NumProj
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強クロスカッター" && Helper(99999),fvar(3) > 0 || Helper(99999),var(11) > 0 && command = "holdy"
triggerall = statetype != A
triggerall =!NumProj
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ムーンスラッシャー" && Helper(99999),fvar(6) > 0 || Helper(99999),var(12) > 0 && command = "holdx"
triggerall = statetype != A
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ムーンスラッシャー" && Helper(99999),fvar(6) > 0 || Helper(99999),var(13) > 0 && command = "holdy"
triggerall = statetype != A
trigger1 = ctrl || stateno = 40 || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱ネックローリング" && Helper(99999),fvar(6) > 0 || Helper(99999),var(14) > 0 && command = "holda"
triggerall = statetype != A
trigger1 = ctrl || stateno = 40 || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強ネックローリング" && Helper(99999),fvar(6) > 0 || Helper(99999),var(15) > 0 && command = "holdb"
triggerall = statetype != A
trigger1 = ctrl || stateno = 40 || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
trigger1 = p2bodydist X >= 180
trigger1 = enemynear(var(58)),movetype = A
trigger1 = enemynear(var(58)),AnimTime <= -37
...
trigger2 = enemynear(var(58)),statetype = A
trigger2 = p2bodydist y = [-80-floor(8*(enemynear(var(58)),vel y)+(8*(8+1)/2)*fvar(39)),0-floor(8*(enemynear(var(58)),vel y)+(8*(8+1)/2)*fvar(39))]
...
trigger1 = Random <= 100 || p2life <= floor(7*fvar(7))
trigger2 = enemynear(var(58)),statetype = A
trigger2 = p2bodydist y = [-80-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(39)),0-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(39))]
trigger2 = Random <= 200 || p2life <= floor(7*fvar(7))
...
triggerall = enemynear(var(58)),stateno != [5710,5715]
triggerall = movehit
trigger1 = stateno = 215 && AnimElemTime(10) > 0 && AnimElemTime(11) < 2
trigger2 = stateno = 245 && AnimElemTime(7) > 0 && AnimElemTime(8) < 2
...
trigger1 = stateno = 400 && AnimElem = 5,>= 0
...
triggerall = (var(40) = 0 && Random <= 250 || var(40) > 0 && Random <= 600) || stateno = 305 || var(57) >= 6 && p2life <= 450
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
triggerall = enemynear(var(58)),stateno != [5710,5715]
triggerall = movehit
trigger1 = 0;stateno = 215 && AnimElemTime(10) > 0 && AnimElemTime(11) < 2
trigger2 = stateno = 235 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger2 = var(10) = 1
trigger3 = 0;stateno = 245 && AnimElemTime(7) > 0 && AnimElemTime(8) < 2
trigger4 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(5) < 0
trigger4 = var(10) = 1
trigger5 = stateno = 410 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger6 = 0;stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger7 = 0;stateno = 250 && AnimElemTime(9) > 0 && AnimElemTime(10) < 0
trigger8 = stateno = 305 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0
trigger9 = stateno = 725 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
triggerall = Random <= var(57) * 125
triggerall = var(9) = 0 && (power < 2000 && Random <= 250 || power >= 2000 && Random <= 600) || var(9) = 1 && Random <= 600 || stateno = 305 || var(57) >= 6 && p2life <= 250
triggerall = var(57) < 6 && Random <= 200 || var(57) >= 6
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
...
triggerall = movehit
trigger1 = 0;stateno = 215 && AnimElemTime(10) > 0 && AnimElemTime(11) < 2
trigger2 = 0;stateno = 235 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger3 = 0;stateno = 245 && AnimElemTime(7) > 0 && AnimElemTime(8) < 2
trigger4 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(5) < 0
trigger5 = stateno = 410 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger6 = 0;stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger7 = 0;stateno = 250 && AnimElemTime(9) > 0 && AnimElemTime(10) < 0
trigger8 = 0;stateno = 305 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0
trigger9 = 0;stateno = 725 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2

;弱／強クロスカッター
[State -1, 弱／強クロスカッター]
type = ChangeState
value = ifelse((Random <= 600 || p2bodydist X <= 25),1000,1010)
triggerall = var(59) = 1
triggerall = var(57) >= 1
triggerall = var(52) = 0
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
...
trigger1 = stateno = 0;215 && AnimElemTime(10) > 0 && AnimElemTime(11) < 2
trigger2 = stateno = 0;245 && AnimElemTime(7) > 0 && AnimElemTime(8) < 2
trigger3 = stateno = 410 && AnimElemTime(6) > 0 && AnimElemTime(7) < 2
trigger4 = stateno = 440 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger5 = stateno = 0;250 && AnimElemTime(9) > 0 && AnimElemTime(10) < 0
trigger6 = stateno = 0;305 && AnimElemTime(6) > 0 && AnimElemTime(7) < 0
trigger7 = stateno = 0;725 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
[State -1, ストームブリンガー 重ね]
type = ChangeState
value = 1300
triggerall = var(59) = 1
triggerall = var(57) >= 1
triggerall = var(52) = 3
triggerall = var(53) = [0,7]
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = p2bodydist x = [ifelse(backedgebodydist<=10,-20,-20+floor(10*(enemynear(var(58)),vel x))),65+floor(10*(enemynear(var(58)),vel x))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = p2bodydist x = [60+floor(18*(enemynear(var(58)),vel x)),120+floor(18*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-75-floor(18*(enemynear(var(58)),vel y)+(18*(18+1)/2)*fvar(39)),0-floor(18*(enemynear(var(58)),vel y)+(18*(18+1)/2)*fvar(39))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = p2bodydist x = [-10+floor(4*(enemynear(var(58)),vel x)),55+floor(4*(enemynear(var(58)),vel x))]
...
[State -1, 弱／強クロスカッター]
type = ChangeState
value = ifelse(Random <= 600,1000,1010)
triggerall = var(59) = 1
triggerall = var(57) >= 1
triggerall = var(52) = 0
triggerall = RoundState = 2 && enemynear(var(58)),life > 0; && Helper(40000),fvar(1) = 0
...
;弱／強キリングブリンガー
[State -1, 弱／強キリングブリンガー]
type = ChangeState
value = ifelse(Random <= 600,1410,1400)
triggerall = var(59) = 1
triggerall = var(57) >= 1
triggerall = var(52) = 0
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
...
trigger1 = p2bodydist x = [-20,35+floor(4*(EnemyNear(Var(58)),vel X)+floor(4*vel X))]
trigger1 = enemynear(var(58)),Pos Y - Pos Y = [-40,40]
trigger2 = Vel X != 0 || prevstateno = 55
trigger2 = p2bodydist x = [-20,50+floor(7*(EnemyNear(Var(58)),vel X)+floor(7*vel X))]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20,30+floor(5*(EnemyNear(Var(58)),vel X)+floor(5*vel X))]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
trigger1 = var(52) != 2 && var(52) != 3
trigger1 = enemynear(var(58)),statetype != A
trigger1 = stateno != 55 && Vel Y >= 0 && Pos Y >= -60-floor(5*vel Y) || stateno = 55 && Time >= 17
trigger2 = enemynear(var(58)),statetype = A
trigger2 = enemynear(var(58)),movetype != H
trigger2 = enemynear(var(58)),Pos Y - Pos Y = [-40,40]
...
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
trigger1 = Vel X = 0 && prevstateno != 55
trigger1 = p2bodydist x = [-20,35+floor(9*(EnemyNear(Var(58)),vel X)+floor(9*vel X))]
trigger1 = enemynear(var(58)),Pos Y - Pos Y = [-60,20]
trigger2 = Vel X != 0 || prevstateno = 55
trigger2 = p2bodydist x = [-20,60+floor(4*(EnemyNear(Var(58)),vel X)+floor(4*vel X))]
trigger2 = enemynear(var(58)),Pos Y - Pos Y = [-60,20]
