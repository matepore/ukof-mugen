...
[State -1, Combo]
type = VarSet
trigger1 = stateno = 200 && Anim = 200 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger2 = stateno = 200 && Anim = 201 && AnimElemTime(2) > 0 && AnimElemTime(3) < 2
trigger3 = stateno = 205 && Anim = 205 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger4 = stateno = 205 && Anim = 206 && AnimElemTime(2) > 0 && AnimElemTime(3) < 2
trigger5 = stateno = 215 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger6 = stateno = 235 && Anim = 235 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger7 = stateno = 235 && Anim = 236 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger8 = stateno = 245 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger9 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger10 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
var(1) = 1

[State -1, Combo]
type = VarSet
trigger1 = stateno = 300 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2
trigger2 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
var(1) = 2

[State -1, SC]
type = VarSet
triggerall = fvar(35) >= 100
trigger1 = (stateno = 1005 || stateno = 1006 || stateno = 1007) && movecontact = [1,6]
trigger2 = (stateno = 1015 || stateno = 1016 || stateno = 1017) && movecontact = [1,6]
trigger3 = stateno = 1205 && movecontact = [1,6]
trigger4 = stateno = 1255 && movecontact = [1,6]
trigger5 = stateno = 1300 && var(13) = 1
trigger6 = stateno = 1420 && movecontact = [1,6]
var(1) = 3

[State -1, DC]
type = VarSet
triggerall = fvar(35) >= 100
trigger1 = stateno = 3000 && movecontact = [1,6]
trigger2 = stateno = 3010 && movecontact = [1,6]
trigger3 = stateno = 3110 && AnimElemTime(9) >= 0 && AnimElemTime(15) < 0 && movecontact
trigger4 = stateno = 3120 && AnimElemTime(2) >= 0 && AnimElemTime(5) < 0 && movecontact
var(1) = 4
...
triggerall = command = "爆真" || helper(99999),var(24) > 0 && command = "holdy"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱絶！激拳" || helper(99999),var(20) > 0 && command = "holdx"
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強絶！激拳" || helper(99999),var(21) > 0 && command = "holdy"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱虎豹連撃" || helper(99999),var(22) > 0 && command = "holda"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強虎豹連撃" || helper(99999),var(23) > 0 && command = "holdb"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱截攻崩撃" || helper(99999),var(14) > 0 && command = "holdx"
triggerall = var(10) = 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
trigger4 = stateno = 1300 && var(13) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強截攻崩撃" || helper(99999),var(15) > 0 && command = "holdy"
triggerall = var(10) = 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "前方転身" || helper(99999),var(16) > 0 && command = "holdz"
triggerall = var(10) = 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "後方転身" || helper(99999),var(17) > 0 && command = "holdz"
triggerall = var(10) = 0
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "伏虎撃" || helper(99999),var(12) > 0 && command = "holdx"
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
trigger3 = var(1) = 2
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弾拳" || helper(99999),var(13) > 0 && command = "holdy"
triggerall = var(10) = 1
triggerall = statetype != A
trigger1 = ctrl || (stateno = [100,101])
trigger2 = var(1) = 1
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "弱激拳" || helper(99999),var(10) > 0 && command = "holdx"
triggerall = statetype != A
trigger1 = stateno = 1100 && animelemtime(5) >= 2 && AnimElemTime(9) < 0
...
triggerall =!Ishelper
triggerall = roundstate = 2
triggerall = command = "強激拳" || helper(99999),var(11) > 0 && command = "holdy"
triggerall = var(10) = 1
triggerall = statetype != A
trigger1 = stateno = 1100 && animelemtime(5) >= 2 && AnimElemTime(9) < 0
...
trigger3 = stateno = 200 && Anim = 201 && AnimElem = 3,>= 0
trigger4 = stateno = 205 && Anim = 205 && AnimElem = 4,>= 0
trigger5 = stateno = 205 && Anim = 206 && AnimElem = 3,>= 0
trigger6 = stateno = 400 && AnimElem = 4,>= 0
trigger7 = stateno = 430 && AnimElem = 5,>= 0
...
triggerall = command != "holddown"
triggerall = statetype != A
triggerall = p2bodydist X <= ifelse(var(10) = 1,20,28)
trigger1 = ctrl || (stateno = [100,101])
...
trigger4 = stateno = 1005 || stateno = 1006 || stateno = 1007 || stateno = 1015 || stateno = 1016 || stateno = 1017
var(52) = 1
...
triggerall = ctrl || (stateno = [20,22]) || stateno = 100 && time >= 8 || (stateno = [120,149])
...
trigger1 = enemynear(var(58)),statetype != A
trigger2 = enemynear(var(58)),statetype = A
trigger2 = p2bodydist y = [-60-floor(2*(enemynear(var(58)),vel y)+(2*(2+1)/2)*fvar(39)),0-floor(2*(enemynear(var(58)),vel y)+(2*(2+1)/2)*fvar(39))]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
trigger1 = stateno = 1006 && movehit = 1
trigger2 = stateno = 1016 && movehit = 1
var(50) = 2
...
triggerall = ctrl || stateno = 0 || (stateno = [19,22]) || (stateno = [99,101]) || (stateno = [120,149])
trigger1 = var(10) = 0
trigger1 = p2bodydist y = [-40-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(39)),20-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(39))]
trigger2 = var(10) = 1
trigger2 = p2bodydist y = [-40-floor(1*(enemynear(var(58)),vel y)+(1*(1+1)/2)*fvar(39)),20-floor(1*(enemynear(var(58)),vel y)+(1*(1+1)/2)*fvar(39))]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
trigger1 = stateno = 3000 && var(6) && movehit = 1
trigger2 = stateno = 3010 && var(6) && movehit = 1
var(50) = 1
...
trigger1 = stateno = 215 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
...
triggerall = movecontact = [1,4]
trigger1 = stateno = 200 && Anim = 200 && AnimElem = 4,>= 0
trigger2 = stateno = 200 && Anim = 201 && AnimElem = 3,>= 0
trigger3 = stateno = 205 && Anim = 205 && AnimElem = 4,>= 0
trigger4 = stateno = 205 && Anim = 206 && AnimElem = 3,>= 0
trigger5 = stateno = 400 && AnimElem = 4,>= 0
trigger6 = stateno = 430 && AnimElem = 5,>= 0
...
trigger2 = stateno = 245 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger3 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger4 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
triggerall = var(57) >= 6
triggerall = var(29) = 0
triggerall = power >= 3000 && fvar(35) >= 100
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
...
trigger3 = stateno = 1205 && movecontact = [1,6]
trigger4 = stateno = 1255 && movecontact = [1,6]
trigger5 = stateno = 1420 && movecontact = [1,6]
trigger6 = stateno = 3110 && AnimElemTime(13) >= 0 && AnimElemTime(15) < 0 && movecontact
trigger6 = fvar(35) >= 200 && enemynear(var(58)),life > 1
trigger7 = stateno = 3120 && AnimElemTime(2) >= 0 && AnimElemTime(5) < 0 && movecontact
trigger7 = fvar(35) >= 200 && enemynear(var(58)),life > 1
...
triggerall = var(59) = 1
triggerall = var(57) >= 6
triggerall = power >= 4000 && fvar(35) >= 200
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
triggerall = Random <= var(57) * 125
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
...
trigger1 = stateno = 200 && Anim = 200 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger2 = stateno = 200 && Anim = 201 && AnimElemTime(2) > 0 && AnimElemTime(3) < 2
trigger3 = stateno = 215 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger4 = stateno = 235 && Anim = 235 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger5 = stateno = 235 && Anim = 236 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger6 = stateno = 245 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger7 = stateno = 400 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger8 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger9 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
triggerall = enemynear(var(58)),movetype = H
triggerall = movehit = [1,4]
trigger1 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
triggerall = random <= 200 || var(57) >= 6 && p2life <= 150 || var(29) != 0
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
...
trigger2 = (stateno = 1015 || stateno = 1016 || stateno = 1017) && movecontact = [1,6]
trigger3 = stateno = 1205 && movecontact = [1,6]
trigger4 = stateno = 1420 && movecontact = [1,6]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
triggerall = (movehit = [1,4]) || (moveguarded = [1,4]) && enemynear(var(58)),statetype = C && random <= 250
trigger1 = stateno = 215 && AnimElemTime(4) > 0 && AnimElemTime(5) < 2
trigger2 = stateno = 245 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger3 = stateno = 410 && AnimElemTime(3) > 0 && AnimElemTime(4) < 2
trigger4 = stateno = 300 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2 && moveguarded
trigger5 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
...
trigger4 = stateno = 300 && AnimElemTime(5) > 0 && AnimElemTime(6) < 2 && moveguarded
trigger5 = stateno = 315 && AnimElemTime(8) > 0 && AnimElemTime(9) < 2
trigger5 = movehit || moveguarded && random <= 250
...
trigger5 = enemynear(var(58)),animtime > -10
var(44) = 10
...
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = enemynear(var(58)),stateno = 5120
trigger1 = enemynear(var(58)),animtime = [-32+((var(52) = 2)*12),-10]

[State -1, しゃがみ強キック 持続ガー不重ね]
type = ChangeState
value = 440
triggerall = var(59) = 1
triggerall = var(57) >= 1
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || (var(1) = [1,2]) && !movecontact && movetype != H
trigger1 = p2bodydist x = [60+floor(9*(enemynear(var(58)),vel x)),160+floor(9*(enemynear(var(58)),vel x))]
...
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = var(10) = 0
trigger1 = p2bodydist x = [0+floor(11*(enemynear(var(58)),vel x)),30+floor(11*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-120-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39)),0-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39))]
trigger2 = var(10) = 1
trigger2 = p2bodydist x = [-10+floor(11*(enemynear(var(58)),vel x)),30+floor(11*(enemynear(var(58)),vel x))]
trigger2 = p2bodydist y = [-100-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39)),0-floor(11*(enemynear(var(58)),vel y)+(11*(11+1)/2)*fvar(39))]
...
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = var(10) = 0
trigger1 = p2bodydist x = [20+floor(15*(enemynear(var(58)),vel x)),60+floor(15*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-75-floor(15*(enemynear(var(58)),vel y)+(15*(15+1)/2)*fvar(39)),0-floor(15*(enemynear(var(58)),vel y)+(15*(15+1)/2)*fvar(39))]
trigger2 = var(10) = 1
trigger2 = p2bodydist x = [40+floor(9*(enemynear(var(58)),vel x)),80+floor(9*(enemynear(var(58)),vel x))]
trigger2 = p2bodydist y = [-75-floor(9*(enemynear(var(58)),vel y)+(9*(9+1)/2)*fvar(39)),0-floor(9*(enemynear(var(58)),vel y)+(9*(9+1)/2)*fvar(39))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149])
trigger1 = p2bodydist x = [-10+floor(7*(enemynear(var(58)),vel x)),30+floor(7*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-75-floor(7*(enemynear(var(58)),vel y)+(7*(7+1)/2)*fvar(39)),0-floor(7*(enemynear(var(58)),vel y)+(7*(7+1)/2)*fvar(39))]
...
triggerall = enemynear(var(58)),MoveType != H
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20,35+floor(5*(EnemyNear(Var(58)),vel X)+floor(5*vel X))]
...
trigger1 = enemynear(var(58)),Pos Y - Pos Y = [-60,0]
trigger2 = (Vel X != 0 || prevstateno = 55)
trigger2 = p2bodydist x = [-20,48+floor(5*(EnemyNear(var(58)),vel X)+floor(5*vel X))]
trigger2 = enemynear(var(58)),Pos Y - Pos Y = [-40,20]
...
trigger1 =!(Vel X != 0 || prevstateno = 55)
trigger1 = enemynear(var(58)),StateType = A
trigger1 = P2BodyDist X = [-20,56+floor(11*(EnemyNear(Var(58)),vel X)+floor(11*vel X))]
trigger1 = enemynear(var(58)),Pos Y - Pos Y = [-40,40]
trigger2 =!(Vel X != 0 || prevstateno = 55)
trigger2 = var(52) != 2 && var(52) != 3
trigger2 = enemynear(var(58)),statetype != A
trigger2 = vel X = 0 && Vel Y >= 0
trigger2 = P2BodyDist X = [-20,56+floor(11*(EnemyNear(Var(58)),vel X)+floor(11*vel X))]
trigger3 = (Vel X != 0 || prevstateno = 55)
trigger3 = var(52) != 2 && var(52) != 3
trigger3 = enemynear(var(58)),statetype != A
trigger3 = P2BodyDist X = [-20,50+floor(9*(EnemyNear(Var(58)),vel X)+floor(9*vel X))]
trigger3 = stateno != 55 && Vel Y >= 0 && Pos Y >= -60-floor(9*vel Y) || stateno = 55 && Time >= 14
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20+floor(14*(EnemyNear(Var(58)),vel X)+floor(14*vel X)),60+floor(14*(EnemyNear(Var(58)),vel X)+floor(14*vel X))]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
trigger1 = enemynear(var(58)),StateType != A
trigger1 = stateno != 55 && (Time = [18,22]) && Vel X > 0
trigger1 = Random <= 400
trigger2 = enemynear(var(58)),StateType != A
trigger2 = enemynear(var(58)),statetype != C
trigger2 = stateno = 55 && (Time = [12,14]) && Vel X > 0
trigger2 = Random <= 250
trigger3 = enemynear(var(58)),StateType = A
...
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
trigger1 = enemynear(var(58)),StateNo = 5608
...
trigger5 = enemynear(var(58)),stateno = 5700
